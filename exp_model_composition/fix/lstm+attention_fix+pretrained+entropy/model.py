...
def inference(input_x, embedding_dim, lstm_hidden_dim_1, vocab_size,
    ...
    with tf.variable_scope('attention_layer'):
        ...
        def step(_,time_step):
            ...
            entropy = tf.reduce_sum(-1*tf.mul(weight,log_weight),axis=1)
        ...
        att_outputs, entropy = tf.scan(step, time_step_sequence, initializer=initializer)
    ...
    return logits, pretrain_list, output_linear_list, entropy
